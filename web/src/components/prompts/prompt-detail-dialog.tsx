...
export function PromptDetailDialog({ prompt, onClose, onCopy, onSaveAsset, extraAction }: { prompt: Prompt | null; onClose: () => void; onCopy: (prompt: string) => void; onSaveAsset?: (prompt: Prompt) => void; extraAction?: ReactNode }) {
    return (
        <>
                        ...
                        <div className="grid gap-5 md:grid-cols-[300px_minmax(0,1fr)]">
                            <div className="space-y-3">
                                {prompt.coverUrl ? (
                                    ...
                                    <div className="flex aspect-[4/3] w-full items-center justify-center rounded-lg bg-stone-100 px-6 text-center text-sm font-medium text-stone-500 dark:bg-stone-800 dark:text-stone-300">{prompt.title}</div>
                                )}
